...
M.recruit_cost_modifier = 0.75
M.maintenance_cost_modifier = 0.75
M.discontent_pay_off = 35
M.discontent_disperse = 40
M.discontent_independence = 45

-- hard difficulty: attack random provinces
